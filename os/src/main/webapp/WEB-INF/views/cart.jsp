<div class="container">
	...
	<c:choose>
		...
		<table id="cart" class="table table-hover table-condensed">
					...
					<c:forEach items="${cartLines}" var="cartLLine">
					
						<tr>
							<td data-th="Product">
								<div class="row">
									<div class="col-sm-2 hidden-xs"><img src="${images}/${cartLine.product.code}.png" alt="${cartLine.product.name}" class="img-responsive cartImg"/></div>
									<div class="col-sm-10">
